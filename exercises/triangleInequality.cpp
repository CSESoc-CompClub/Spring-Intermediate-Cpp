...
// a triangle are related to each other. In particular, it tells us that the
// length of the longest side of the triangle cannot be more than the sum of the two
